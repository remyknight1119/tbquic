...
uint8_t *WPacket_get_data(WPacket *, size_t);
...
int WPacketReserveBytes(WPacket *, size_t, uint8_t **);
...
int WPacketStartSubBytes(WPacket *, size_t);
...
int WPacketSubAllocBytesU16(WPacket *, size_t, uint8_t **);
